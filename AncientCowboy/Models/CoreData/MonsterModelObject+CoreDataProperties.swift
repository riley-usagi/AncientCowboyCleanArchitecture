//
//  MonsterModelObject+CoreDataProperties.swift
//  AncientCowboy
//
...
extension MonsterModelObject {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<MonsterModelObject> {
        return NSFetchRequest<MonsterModelObject>(entityName: "MonsterModelObject")
    }
